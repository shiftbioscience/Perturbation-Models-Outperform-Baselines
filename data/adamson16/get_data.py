...
data_url = 'https://zenodo.org/record/10044268/files/AdamsonWeissman2016_GSM2406681_10X010.h5ad'
data_cache_dir = './data/adamson16'
...
adata.obs['perturbation'] = adata.obs['perturbation'].str.split('_').str[0]
ctrl_cells = adata.obs[adata.obs['perturbation'].str.contains('\(') == True].index
adata.obs.loc[ctrl_cells, 'perturbation'] = 'control'
adata.obs['perturbation'] = adata.obs['perturbation'].astype('category')
adata.obs['condition'] = adata.obs.perturbation.copy()


# Add donor_id column (required by pipeline but constant for adamson16)
adata.obs['donor_id'] = 'adamson16'
...
output_path = f'{data_cache_dir}/adamson16_processed_complete.h5ad'
