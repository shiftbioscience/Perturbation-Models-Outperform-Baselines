...
data_url = 'https://zenodo.org/record/7041849/files/TianKampmann2021_CRISPRi.h5ad'
data_cache_dir = './data/tian21crispri'
DATASET_NAME = 'tian21crispri'
...
# Add donor_id column (required by pipeline but constant for DATASET_NAME)
