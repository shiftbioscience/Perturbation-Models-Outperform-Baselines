...
data_url = 'https://zenodo.org/records/15200179/files/fibroblast_CRISPRa_final_pop.h5ad?download=1'
data_cache_dir = 'data/kaden25fibroblast'
DATASET_NAME = 'kaden25fibroblast'
...
# Add donor_id column (required by pipeline but constant for kaden25fibroblast)
