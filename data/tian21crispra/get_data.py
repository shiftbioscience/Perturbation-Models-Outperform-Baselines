...
data_url = 'https://zenodo.org/record/10044268/files/TianKampmann2021_CRISPRa.h5ad'
data_cache_dir = 'data/tian21crispra'
DATASET_NAME = 'tian21crispra'
CELL_TYPE = 'iPSC_derived_neurons'
...
# Add donor_id column (required by pipeline but constant for tian21crispra)
