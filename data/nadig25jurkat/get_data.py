...
data_url = 'https://ftp.ncbi.nlm.nih.gov/geo/series/GSE264nnn/GSE264667/suppl/GSE264667%5Fjurkat%5Fraw%5Fsinglecell%5F01.h5ad'
data_cache_dir = 'data/nadig25jurkat'
DATASET_NAME = 'nadig25jurkat'
CELL_TYPE = 'jurkat'
...
adata.obs['perturbation'] = adata.obs['perturbation'].str.replace('non-targeting', 'control')
...
# Add donor_id column (required by pipeline but constant for nadig25jurkat)
